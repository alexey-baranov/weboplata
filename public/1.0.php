...
Logger::getLogger("1.0.file_get_content")->debug($_REQUEST);
$url="https://10.1.12.114:9443/weboplata/main?".$_SERVER["QUERY_STRING"];
//$url="https://hydra.tele-plus.ru:9443/weboplata/main?".$_SERVER["QUERY_STRING"];
Logger::getLogger("1.0.file_get_content")->debug($url);

$html = file_get_contents($url);
Logger::getLogger("1.0.file_get_content")->debug($html);
